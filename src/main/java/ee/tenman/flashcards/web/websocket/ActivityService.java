package ee.tenman.flashcards.web.websocket;

import ee.tenman.flashcards.security.SecurityUtils;
import ee.tenman.flashcards.web.websocket.dto.ActivityDTO;
...
import static ee.tenman.flashcards.config.WebsocketConfiguration.IP_ADDRESS;
